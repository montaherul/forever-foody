    ...
    >
      <div className="grid grid-flow-row-dense grid-cols-2 grid-rows-2 gap-8">
        <label htmlFor="image1" className="col-span-1">
          <img
            className="w-20"
            src={previewSrc(image1, existingImages[0])}
            alt=""
          />
          <input
        ...
        <label htmlFor="image2" className="col-span-1">
          <img
            className="w-20"
            src={previewSrc(image2, existingImages[1])}
            alt=""
          />
          <input
        ...
        <label htmlFor="image3">
          <img
            className="w-20"
            src={previewSrc(image3, existingImages[2])}
            alt=""
          />
          <input
        ...
        <label htmlFor="image4">
          <img
            className="w-20"
            src={previewSrc(image4, existingImages[3])}
            alt=""
          />
          <input
