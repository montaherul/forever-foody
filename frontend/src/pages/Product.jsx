  ...
  const fetchProductData = useCallback(() => {
    ...
    if (product) {
      ...
      if (product.sizes && product.sizes.length > 0) {
        const firstSize = product.sizePricing
          ? Object.keys(product.sizePricing)[0]
          : product.sizes[0];
                      ...
                      <table className="w-full table-auto border-collapse">
                        <tbody>
                          {specsEntries.map(([key, value], index) => (
                            ...
                            >
                              <td className="border px-6 py-4 font-semibold text-gray-700 w-1/3">
                                {key}
                              </td>
                              ...
                              <div className="flex items-center gap-1">
                                {[1, 2, 3, 4, 5].map((star) => (
                                  <img
                                    ...
                                    className="w-4"
                                    alt={
                                      star <= rev.rating ? "Star" : "Dull Star"
                                    }
                                  />
                                ))}
                              </div>
